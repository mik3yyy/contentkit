  ...
  return (
    <section className="bg-[#111] py-36 text-center">
      <div className="max-w-[860px] mx-auto px-6">
        ...
        <Link href="/checkout" className="inline-flex items-center gap-2.5 bg-white text-black font-bold text-[16px] px-10 py-5 rounded-2xl hover:bg-gray-100 transition-colors">
          Get ContentKit
